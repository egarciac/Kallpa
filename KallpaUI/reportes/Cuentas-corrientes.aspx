<<<<<<< .mine
﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cuentas-corrientes.aspx.cs" Inherits="KallpaUI.reportes.reporte_cuentas_corrientes" %>
...
<body>
   ...
   <a href="Poliza.aspx" target="_self">
    ...
    <div class="portada-imagen">
    	<div class="text">
			...
			<h1 style="margin: 0; margin-left:-135px;">Cuentas Corrientes</h1>
		</div>
    ...
    <div class="contenido-medio">
      ...
      <div class="bienvenida-intern2"> 
         	<div style="float:left; overflow:hidden; width:280px">
              ...
              <div style="margin-bottom:26px; overflow:hidden">
            			...
            			<div style="float:left; overflow:hidden; margin-right:15px;">
         					<input name="" type="text"  class="caja"/>
            			</div>
            ...
            <div style="float:left; overflow:hidden; width:280px">
       		  ...
       		  <div style="margin-bottom:26px; height:0px; overflow:hidden"></div>
             ...
             <div style="float:left; overflow:hidden; width:200px">
					<div style="margin-bottom:26px; height:30px; overflow:hidden"></div>
      ...
      <div style="overflow:hidden; width:800px; margin-top:20px; display:none">
       	  	<span class="texto14azul"><strong>> Cuenta corriente:  </strong></span>01/11/2012 al 30/11/2012</div>
      ...
      <div class="contenedor-reportes" style="display:none">
             ...
             <div style="overflow:hidden; margin-top:10px;">
           	   ...
           	   <table width="928" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  <tr>
    <td><table width="928" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="103" height="42" align="center" bgcolor="#758a9d"><span class="texto13blanco">Fecha <br />
          Operación</span></td>
        ...
        <td width="354" align="center" bgcolor="#758a9d"><span class="texto13blanco">Descripcón</span></td>
        <td width="93" align="center" bgcolor="#758a9d"><span class="texto13blanco">Cargo</span></td>
        <td width="92" align="center" bgcolor="#758a9d"><p><span class="texto13blanco">Abono</span>
        </p></td>
        <td width="92" align="center" bgcolor="#758a9d"><span class="texto13blanco">Saldo</span></td>
        </tr>
    </table></td>
  </tr>
  <tr><td height="55">&nbsp;&nbsp;&nbsp;Operaciones vencidas</td></tr>
  <tr>
    <td>
      <table width="928" border="0" cellspacing="2" cellpadding="0">
        <tr>
          <td width="103" height="20" align="center" bgcolor="#d2d9df">30/11/2012</td>
          <td width="95" align="center" bgcolor="#d2d9df">10, 000</td>
          <td width="91" align="center" bgcolor="#d2d9df">&nbsp;</td>
          <td width="354" align="center" bgcolor="#d2d9df">Dev. M.G. Op. 108 del 03/10/2012 FL2 03/12/2012 </td>
          <td width="93" align="center" bgcolor="#d2d9df">&nbsp;</td>
          <td width="92" align="center" bgcolor="#d2d9df"><p>200.00</p></td>
          <td width="92" align="center" bgcolor="#d2d9df">200.00</td>
          </tr>
        </table>
      </td>
  </tr>
  ...
  <tr>
    <td><table width="928" border="0" cellspacing="2" cellpadding="0">
        <tr>
          <td width="103" height="20" align="center">30/11/2012</td>
          <td width="95" align="center">10, 000</td>
          <td width="91" align="center">&nbsp;</td>
          <td width="354" align="center">Traspaso de CASTILLEJO CUEVA, DIAMELA ALEJANDRA </td>
          <td width="93" align="center">&nbsp;</td>
          <td width="92" align="center"><p>204.04</p></td>
          <td width="92" align="center">204.04</td>
          </tr>
        </table></td>
  </tr>
  <tr>
    <td><table width="928" border="0" cellspacing="2" cellpadding="0">
        <tr>
          ...
          <td width="95" align="center" bgcolor="#d2d9df">10, 000</td>
          <td width="91" align="center" bgcolor="#d2d9df">&nbsp;</td>
          <td width="354" align="center" bgcolor="#d2d9df">Traspaso de CASTILLEJO CUEVA, ANDREA ELIZABETH </td>
          <td width="93" align="center" bgcolor="#d2d9df">&nbsp;</td>
          <td width="92" align="center" bgcolor="#d2d9df"><p>47.48</p></td>
          <td width="92" align="center" bgcolor="#d2d9df">47.48</td>
          </tr>
        </table></td>
  </tr>
  <tr><td><table width="928" border="0" cellspacing="2" cellpadding="0">
        <tr>
          <td width="103" height="20" align="center">30/11/2012</td>
          <td width="95" align="center">10, 000</td>
          <td width="91" align="center">&nbsp;</td>
          <td width="354" align="center">Compra US$ a T.C. 2.5850000000</td>
          <td width="93" align="center">451.52</td>
          <td width="92" align="center"><p>&nbsp;</p></td>
          <td width="92" align="center">0.00</td>
          </tr>
        </table></td></tr>
  <tr>
    <td height="30">&nbsp;</td>
  ...
  <tr>
    <td height="20"><table width="928" border="0" cellspacing="2" cellpadding="0">
        <tr>
          <td width="103" height="20" align="center">&nbsp;</td>
          <td width="95" align="center">&nbsp;</td>
          <td width="91" align="center">&nbsp;</td>
          <td width="354" align="center">Saldos de Cuenta Corriente Nuevos Soles al 30/11/2012</td>
          <td width="93" align="center">451.52</td>
          <td width="92" align="center"><p>451.52</p></td>
          <td width="92" align="center">0.00</td>
          </tr>
        </table></td>
  </tr>
  ...
  <tr>
    <td height="20">&nbsp;&nbsp;&nbsp;Operaciones vencidas</td>
  </tr>
  <tr>
    <td height="20"><table width="928" border="0" cellspacing="2" cellpadding="0">
        <tr>
