...
<body>
	...
	<div class="header">
	  <div class="logo"><ahref="Login.aspx"><img src="img/logo.jpg" width="290" height="60" /></ahref></div>
      <div style="float:right; width:300px; margin-top: overflow:hidden">
       	<div style="float:left; margin-right:2px;"><a href="#" style="text-decoration:none"> <span class="texto13azul">Favoritos</span></a><span class="texto13azul" style="margin-left:18px">Recomendar</span><span class="texto13azul" style="margin-left:18px">Mapa</span><span class="texto13azul" style="margin-left:18px">Webmail</span></div>
            <div style="float:left; margin-right:26px; margin-top:5px; margin-left:13px;"><a href="#" style="text-decoration:none"><img src="img/mapa-usa.jpg" width="16" height="11" border:"0" /></a></div>
  ...
  <div class="menu" style="height:28px;">
	<a href="#" target="_self">
    <div class="e" style="float:left; margin-right:33px; padding-bottom:5px; padding-top:7px; padding-left:5px; padding-right:5px;"><span class="texto18e"></span></div>
    </a>
    <a href="#" target="_self">
    <div class="e"  style="float:left; margin-right:33px; padding-bottom:5px; padding-top:7px; padding-left:5px; padding-right:5px;"><span class="texto18e"></span></div>
    </a>
   ...
   <a href="#" target="_self">
    ...
    <div class="portada-error">
    	
    <img src="img/error.jpg" width="1042" height="168" />
    </div>
    
    <div class="contenido-error">
      <div style="margin-bottom:5px; margin-left:126px; margin-top:77px"><span class="texto30azul"><strong>Disculpe los inconvenientes, <br />
