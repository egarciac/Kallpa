...
namespace KallpaUI
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
                if (!IsPostBack)
                {
                    ...
                    imagen.ImageUrl = ResolverUrl("http://www.stockcharts.com/c-sc/sc?s=$SPX&p=D&yr=0&mn=3&dy=0&i=t50258449236&r=1385929837306");
        ...
        //{
        //    Response.Redirect(Image1, false);
        //}

        //private void ListPolizas()
        //{
        //    Poliza poliza = new Poliza();
        //    GridView1.DataSource = poliza.ListPolizas().Tables[0].DefaultView;
        //    GridView1.DataBind();
        //}

        /*
        Create or Replace 
        PROCEDURE "SP_LIST_POLIZAS" (ResCursor IN OUT SYS_REFCURSOR)
        AS
        BEGIN
         OPEN ResCursor
         For Select
         ClienteID, NumPoliza, Monto from Polizas order by Cliente ID ASC;
        END;
        */
